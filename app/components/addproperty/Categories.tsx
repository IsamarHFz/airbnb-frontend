    ...
    return (
        <>
            <div className="pt-3 cursor-pointer pb-6 flex item-center space-x-12">
                ...
                <div 
                    onClick={() => setCategory('Cabinas')}
                    className={`pb-4 flex flex-col items-center space-y-2 border-b-2 ${dataCategory == 'Cabinas' ? 'border-gray-800': 'border-white'} opacity-60 hover:border-gray-200 hover:opacity-100`}
                >
                    <Image 
                        src="/icn_category_beach.jpeg"
                        alt="Category - Beach" 
